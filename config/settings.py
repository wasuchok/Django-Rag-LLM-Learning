...
AI_ORCHESTRATOR = os.getenv("AI_ORCHESTRATOR", "langgraph").strip().lower() or "langgraph"
OLLAMA_THINK = get_bool_env("OLLAMA_THINK", False)
OLLAMA_KEEP_ALIVE = os.getenv("OLLAMA_KEEP_ALIVE", "15m").strip() or "15m"
OLLAMA_NUM_PREDICT = get_int_env("OLLAMA_NUM_PREDICT", 1536)
...
RAG_SEARCH_TOP_K = max(1, int(os.getenv("RAG_SEARCH_TOP_K", "30")))
